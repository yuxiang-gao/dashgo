...
class VoiceNav:
    def __init__(self):
        rospy.init_node('voice_nav', log_level=rospy.DEBUG)
        ...
        rospy.Subscriber('/nav_cmd', String, self.speech_callback)
        ...
        # We have to keep publishing the cmd_vel message if we want the robot
        # to keep moving.
